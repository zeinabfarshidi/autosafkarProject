@section('title', 'ویرایش درخواست در ' . $request->ad->title)
<div>
    <main class="body">
                        ...
                        <div class="d-flex w-div-49 jsc-space-between flex-wrap flex-direction">
                            <div>
                                <div class="form-group mb-5">
                                    <textarea wire:model.lazy="request.description" class="form-control textarea" rows="2" id="description" placeholder="توضیحات" style="box-shadow: none;"></textarea>
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <div class="card form-group d-flex jsc-center alc-center p-0 input_file_box upload_box">
                                        ...
                                        @elseif($request->img)
                                            <img src="{{ asset('storage/' . $request->img) }}" alt="">
                                        @endif
                                    </div>
                                </div>
