    ...
    <main class="body border-bottom" wire:init="loadInformation">
        <article class="single-page-container">
            <header class="postHeader">
                <h1 class="title_h">{{ $post->title }}</h1>
                <div class="post-details">
                    @foreach($post->categories as $category)
                        <span class="post-categories">{{ $category->name }}</span>
                    @endforeach
                    <span class="publicationDate">{{ verta($post->created_at)->format('Y/m/d') }}</span>
                </div>
                <div class="post-author">
                    <div class="post-author-img">
                        @if($post->user->img)
                            <img alt="" src="{{ asset('storage/' . $post->user->img) }}">
                        @else
            ...
            <div class="d-flex jsc-space-between alc-start singlePagePostContent single-page-post-content">
                ...
                <div class="single-page-right">
                    <div class="post-content">
                        <img src="{{ asset('storage/' . $post->img) }}" alt="" class="mt-0 mb-3">
                        <div class="card card-post-ad border-0">
                            ...
                            <div class="card-body">
                                <a href="{{ \App\Models\Banner::all()->random()->link }}"><img
                                        src="{{ asset('storage/' . \App\Models\Banner::all()->random()->img) }}" alt=""></a>
                            </div>
                        </div>
                    ...
                    <div class="card card-post-comment">
                        <div class="card-header d-flex jsc-space-between alc-center p-2">
                            ...
                            <div>
                              ...
                              @if(auth()->user() && $post->likes->where('user_id', auth()->user()->id)->first())
...
@endif"></a>
                        ...
                        <div class="hottest-content-of-day-list">
                            <a href="">
                                <div class="hottest-content-of-day-img">
                                    <img
                                        src="{{ asset('storage/home/images/post/Best-foldable-phones-66e9553b880241bd74145914.webp') }}"
                                        alt="">
                                </div>
                ...
                <aside class="post-sidebar">
                    <div class="card card-post-ad border-0">
                        ...
                        <div class="card-body">
                            <a href="{{ \App\Models\Banner::all()->random()->link }}"><img
                                    src="{{ asset('storage/' . \App\Models\Banner::all()->random()->img) }}"
                                    alt=""></a>
                            <a href="{{ \App\Models\Banner::all()->random()->link }}"><img
                                    src="{{ asset('storage/' . \App\Models\Banner::all()->random()->img) }}"
                                    alt=""></a>
                            ...
                            <li>
                                <a href="">
                                    <div class="new-content-img">
                                        <img
                                            src="{{ asset('storage/home/images/post/2022-3-manage-restrict-data-usage-smartphones-638bb71ae60c0026b8253e17.webp') }}"
                                            alt="" class="">
                                    </div>
    ...
    <div class="single-page-container mt-0" id="postBottom">
        ...
        <div class="comment-card">
            <div class="comment-card-header border-bottom">
                ...
                @else
                    <div class="comment-svg">
                        ...
                        <a href="{{ route('login') }}" class="btn btnDark">ورود / ثبت‌نام</a>
                    </div>
                @endauth
            ...
            <div class="comment-card-body">
                @if($post->comments->where('status', 'تایید شده')->count() > 0)
                        ...
                        <a class="swiper-slide">
                            <div class="slider__box">
                                <div class="slider__image">
                                    <img src="{{ asset('storage/' . $post->img) }}" class="slider__img" alt="">
                                </div>
