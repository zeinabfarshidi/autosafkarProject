...
} elseif ($_instance->childHasBeenRendered('l1040266283-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1040266283-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1040266283-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1040266283-0');
} else {
    $response = \Livewire\Livewire::mount('home.profile.sidebar', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1040266283-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <div class="content">
                                        ...
                                        <?php if($readyToLoad): ?>
                                            ...
                                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr role="row">
                                                    ...
                                                    <td class="td-ad-info">
                                                        <a href="<?php echo e(route('order.show', $order->id)); ?>" target="_blank">
                                                            <?php echo e($order->problem); ?>

                                                        </a>
                                                        <p class="content_col"><?php echo $order->description; ?></p>
                                                    </td>
                                                    <td class="position-relative">
                                                        <div class="position-absolute bottom-0 left-0 w-100">
                                                            ...
                                                            <a onclick="deleteItem(event, <?php echo e($order->id); ?>)"
                                                               ...
                                                               title="حذف"></a>
                                                            <a href="<?php echo e(route('order.update', $order->id)); ?>"
...
<?php /**PATH D:\projects\aryatehran\autosafkar\project\resources\views/livewire/home/order/index.blade.php ENDPATH**/ ?>